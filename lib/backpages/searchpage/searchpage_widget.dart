...
import '/backpages/product_component/product_component_widget.dart';
                                      ...
                                      return TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          labelText: FFLocalizations.of(context)
                                              .getText(
                                            '512i7wyn' /* Search for Product, Brand, Cat... */,
                                          ),
                                          labelStyle:
                                              FlutterFlowTheme.of(context)
                                                  .labelMedium
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'ctu0twhz' /*  search Result */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    fontFamily: 'Inter',
                                    color: const Color(0xFFD3D3DF),
                                    fontSize: 18.0,
                                    letterSpacing: 0.0,
                                  ),
                            ),
                      ...
                      if (!FFAppState().searchstate)
                        Expanded(
                          child: Padding(
                            ...
                            child: Builder(
                              builder: (context) {
                                final product = searchpageProductsRecordList
                                    .map((e) => e)
                                    .toList();
