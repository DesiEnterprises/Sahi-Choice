      ...
      child: Column(
        ...
        children: [
              ...
              children: [
                Text(
                  FFLocalizations.of(context).getText(
                    '4g0vs6ji' /* Want to Link or Change your Ph... */,
                  ),
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        context.pushNamed('phonepage');
                      },
                      text: FFLocalizations.of(context).getText(
                        'jyhvy4vo' /* Phone Number */,
                      ),
                      icon: const Icon(
                        Icons.phone,
                        size: 15.0,
          ...
          Padding(
            ...
            child: Text(
              FFLocalizations.of(context).getText(
                'pk6soxbc' /* Edit your the content below to... */,
              ),
            ...
            child: AuthUserStreamWidget(
              builder: (context) => TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: FFLocalizations.of(context).getText(
                    'jun6uckj' /* A Short description about you.... */,
                  ),
                  hintStyle: FlutterFlowTheme.of(context).labelMedium.override(
                        fontFamily: 'Inter',
                        letterSpacing: 0.0,
          ...
          Align(
            alignment: const AlignmentDirectional(0.0, 0.0),
            child: Padding(
              padding: const EdgeInsetsDirectional.fromSTEB(40.0, 15.0, 30.0, 10.0),
              child: FFButtonWidget(
                onPressed: () async {
