                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'rk37znmg' /* SAHI DEKHO SAHI CHUNO */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .titleSmall
                                              ...
                                              children: [
                                                TextSpan(
                                                  text: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'j551x3zp' /* Enter the 6 digit code that yo... */,
                                                  ),
