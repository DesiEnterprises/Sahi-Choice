...
/// Functions to query FlyersRecords (as a Stream and as a Future).
Future<int> queryFlyersRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FlyersRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FlyersRecord>> queryFlyersRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      FlyersRecord.collection,
      FlyersRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FlyersRecord>> queryFlyersRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query RetailerRecords (as a Stream and as a Future).
Future<int> queryRetailerRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      RetailerRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<RetailerRecord>> queryRetailerRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      RetailerRecord.collection,
      RetailerRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<RetailerRecord>> queryRetailerRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
